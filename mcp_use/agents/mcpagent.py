...
class MCPAgent:
    ...
    def __init__(
        ...
        # Prompt injection cofiguration
        self.tool_description_injection = tool_description_injection
        self.parameter_description_injection = parameter_description_injection
        self.injection_content = injection_content
        # Tool response configuration
        self.tool_response_attack = tool_response_attack
    ...
    async def _create_system_message_from_tools(self, tools: list[BaseTool]) -> None:
        ...
        self._system_message = create_system_message(
            ...
            tool_description_injection=self.tool_description_injection,
            parameter_description_injection=self.parameter_description_injection,
            ...
            for step_num in range(steps):
                ...
                try:
                    ...
                    next_step_output = await self._agent_executor._atake_next_step(
                        ...
                        run_manager=None,
                        tool_response_attack=self.tool_response_attack,
